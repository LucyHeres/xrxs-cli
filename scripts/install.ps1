...
#
# 用法:
#   irm https://your-domain.com/xrxs/install.ps1 | iex
#
# 环境变量:
...
$Archive = "xrxs_${Version}_${Platform}.zip"
...
Write-Host ""
Write-Host "  安装完成! 重新打开终端后运行:"
Write-Host ""
Write-Host "    xrxs auth login --base-url https://your-company.example.com"
Write-Host "    xrxs approval list search --status 0"
Write-Host ""
